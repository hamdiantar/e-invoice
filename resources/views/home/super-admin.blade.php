            ...
            <div class="col-md-4">
                ...
                <div class="card card-custom bg-info rounded-0 mb-2"  >
                    ...
                    <div class="card-body">
                        ...
                        <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 d-block">{{\App\Models\User::where('type', 'customer')->count()}}</span>
            ...
            <div class="col-md-4" >
                ...
                <div class="card card-custom bg-info  rounded-0 mb-2"  >
                    ...
                    <div class="card-body">
                        ...
                        <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 d-block">{{\App\Models\User::where('type', 'store')->count()}}</span>
                ...
                <div class="card card-custom bg-info  rounded-0 mb-2"  >
                    ...
                    <div class="card-body">
                        ...
                        @if(auth()->user()->type == 'store')
                            <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 d-block">{{\App\Models\Invoice::where('store_id', auth()->id())->count()}}</span>

                        @else
                            <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 d-block">{{\App\Models\Invoice::count()}}</span>
