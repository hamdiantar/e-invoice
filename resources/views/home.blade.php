...
<head>
    ...
    <link href="{{asset('front/vendor/bootstrap/css/bootstrap.rtl.min.css')}}" rel="stylesheet">
    ...
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                @auth
                    <li class="dropdown"><a href="#"><span style="margin-left:10px;">  مرحبا بك {{auth()->user()->name}} </span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
        ...
        <div class="row">
            <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
                <div>
                    ...
                    <a href="{{route('register')}}?role=store" class="download-btn"><i class="bx bxl-play-store"></i>  الأنضمام كمتجر</a>
                    <a href="{{route('register')}}?role=customer" class="download-btn"><i class="bx bxl-apple"></i> الأنضمام كعميل </a>
                </div>
            </div>
...
<main id="main">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <form action="/" method="get">
                            <input type="text" name="q" value="{{request()->q}}"><input type="submit" value="ابحث الأن">
                        </form>
                    </div>
                    @auth
                            <div class="container">
                                            ...
                                            @if(count($invoices))
                                                @foreach($invoices as $invoice)
                                                    <tr>
                                                        ...
                                                        <td><a href="{{route('printInvoice' , $invoice->id)}}" target="_blank" class="btn btn-primary"><i class="bi bi-printer-fill"></i>
                                                            </a></td>
                                                    </tr>
                                                @endforeach
                                            @else
        ...
        <div class="container-fluid" data-aos="fade-up">
            <div class="gallery-slider swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><a href="{{asset('front/img/1.png')}}" class="gallery-lightbox" data-gall="gallery-carousel"><img src="{{asset('front/img/1.png')}}" class="img-fluid" alt=""></a></div>
                    <div class="swiper-slide"><a href="{{asset('front/img/2.png')}}" class="gallery-lightbox" data-gall="gallery-carousel"><img src="{{asset('front/img/2.png')}}" class="img-fluid" alt=""></a></div>
                    <div class="swiper-slide"><a href="{{asset('front/img/3.png')}}" class="gallery-lightbox" data-gall="gallery-carousel"><img src="{{asset('front/img/3.png')}}" class="img-fluid" alt=""></a></div>
                    <div class="swiper-slide"><a href="{{asset('front/img/4.png')}}" class="gallery-lightbox" data-gall="gallery-carousel"><img src="{{asset('front/img/4.png')}}" class="img-fluid" alt=""></a></div>
                </div>
    ...
    <section id="Login" class="contact">
        <div class="container" data-aos="fade-up">
            ...
            <div style="justify-content: space-around;" class="row">
                <div class="col-lg-8">
                    <form style="box-shadow: 0 0 6px 3px #a19a9a;padding: 18px; border-radius: 5px;" action="{{ route('login') }}" method="post" role="form" class="php-email-form" data-aos="fade-up">
