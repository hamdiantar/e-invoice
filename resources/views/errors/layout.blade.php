...
<html lang="en">
	...
	<head>
		...
		<!--end::Layout Themes-->
		<link rel="shortcut icon" href="{{ asset("imgs/logo-2.png") }}" />
	</head>
	<!--end::Head-->
	<!--begin::Body-->
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="error error-6 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url({{ asset('assets/media/error/bg6.jpg') }});">
				...
				<div class="d-flex flex-column flex-row-fluid text-center">
					<h3 class="error-title font-weight-boldest text-white mb-12" style="margin-top: 12rem;">( @yield("code") ) Oops... <u><a href="{{ url()->previous() }}" class="text-white"> @lang('common.Back') </a></u></h3>
