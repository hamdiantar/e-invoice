            ...
            <div class="row mt-5">
                <div class="col-md-8">
                    <ol class="breadcrumb text-muted fs-6 fw-bold bg-white">
                        <li class="breadcrumb-item pe-3"><a href="#" class="pe-3 font-weight-boldest">المتاجر</a></li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label"> المتاجر [<span class="text-danger pt-2">{{ $items->count() }}</span>] </h3>
            </div>
